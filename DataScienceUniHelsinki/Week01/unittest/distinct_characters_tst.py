...
from Week01.distinct_characters import distinct_characters
...
class DistinctCharacters(unittest.TestCase):
    ...
    def test_random(self):
        for n in range(10):
            ...
            for s in L:
                self.assertEqual(len(compress(sorted(s))), d[s],
                                 msg="Number of distinct characters of word '%s' was incorrect!" % s)
